...
Last sync review: **upstream v4.0.0** (2026-07-23), reviewed 2026-08-01.
Previous: v3.5.2 (reviewed, nothing adopted), v3.5.1, v3.4.2.
...
- **"Bruno Apps"** (`type === 'app'`, HTML/JS mini-UIs in a webview), **file
  mode** (raw text of every request on the tree payload — doubles it for 11,700
  files), **WebSocket multi-message** (we reverted it deliberately in 7c2b64731).
