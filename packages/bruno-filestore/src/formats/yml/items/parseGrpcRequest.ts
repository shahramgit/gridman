...
const parseGrpcRequest = (ocRequest: GrpcRequest): BrunoItem => {
  ...
  // message
  // a list holds the messages of a streaming request; a plain string is the single
  // message shape, still what the writer emits for one message. Upstream: 240826ebc (#8203)
