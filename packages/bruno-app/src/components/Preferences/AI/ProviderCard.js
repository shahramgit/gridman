...
import { clearAiApiKey, getAiApiKey, setAiApiKey, testAiProvider } from 'providers/ReduxStore/slices/ai';
...
/**
 * A hosted provider (OpenAI / Anthropic). Entirely optional — a workspace can
 * run on self-hosted endpoints alone, so nothing here is a prerequisite for
 * the rest of the AI configuration.
 */
const ProviderCard = ({ provider, providerEnabled, providerToggle, models, isModelEnabled, onToggleModel, onStatusChange }) => {
      ...
      >
        ...
        <div className="flex items-center gap-2.5 flex-shrink-0">
          ...
          >
            ...
            {provider.configured ? `${enabledModelsCount}/${models.length} models` : 'Not configured'}
          </span>
