  ...
  return (
    <Modal size="lg" title="Share Collection" handleCancel={onClose} hideFooter>
      <StyledWrapper className="flex flex-col">
        ...
        {/* Gridman Format Section */}
        <div className="section-title">Gridman Format</div>
        <div className="bruno-format-grid mb-6">
          ...
          >
            <div className="card-header">
              <span className="card-title">Gridman Collection (ZIP)</span>
            ...
            <div className="feature-list">
              ...
              <div className="feature-item">
                <IconCheck size={14} className="checkmark" />
                <span>Extract and open directly in Gridman</span>
              </div>
            </div>
